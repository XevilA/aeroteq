...
void handleCmd(String cmd) {
  ...
  // --- DEVELOPER / DEBUG COMMANDS ---
    ...
    Serial.println("[DEV] Rebooting...");
    delay(200);
    ESP.restart();
  }
  else if (cmd.equalsIgnoreCase("RESET FACTORY")) {
    Serial.println("[DEV] Wiping EEPROM...");
    ...
    bleNotify(String(buf));
     ...
     // Force status update logic if needed
  }
}
...
void setup() {
  ...
  loadEEP();
  attachServos(); startMoveTo(angles[lastPos]);
  bleInit();
